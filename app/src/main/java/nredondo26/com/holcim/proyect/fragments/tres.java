...
public class tres extends Fragment {
    ...
    String idzona;
    public String res;
    public  static  final  String URL_IP="http://appholcim.com/ccbrigadistas.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_tres, container, false);
        myrecyclerview = v.findViewById(R.id.contac_recyclerview3);
        mData = new ArrayList<>();
